...
REM =======Build image=======
docker build --no-cache -f matchgame/Dockerfile -t asia-east1-docker.pkg.dev/gladiatortest1/gladiators/gladiators-matchgame:0.1.43 .
@if ERRORLEVEL 1 exit /b 1

REM =======Push image=======
docker push asia-east1-docker.pkg.dev/gladiatortest1/gladiators/gladiators-matchgame:0.1.43
@if ERRORLEVEL 1 exit /b 1
