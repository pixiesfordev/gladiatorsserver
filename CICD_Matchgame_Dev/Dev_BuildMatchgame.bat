...
REM =======Build image=======
docker build --no-cache -f matchgame/Dockerfile -t asia-east1-docker.pkg.dev/mygladiators-dev/gladiators/gladiators-matchgame:0.1.35 .
@if ERRORLEVEL 1 exit /b 1

REM =======Push image=======
docker push asia-east1-docker.pkg.dev/mygladiators-dev/gladiators/gladiators-matchgame:0.1.35
@if ERRORLEVEL 1 exit /b 1
