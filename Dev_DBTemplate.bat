...
mongosh "mongodb+srv://cluster-gladiators.8yp6fou.mongodb.net/?authSource=%%24external&authMechanism=MONGODB-X509" --apiVersion 1 --tls --tlsCertificateKeyFile ".\Keys\aura-developer.pem" -f Dev_DBTemplate.js
