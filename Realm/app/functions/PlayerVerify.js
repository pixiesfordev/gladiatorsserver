exports = async function PlayerTokenVerify(data) {
  ...
  // const findEndpoint = ah.GameSetting.AppEndpoint.Dev + `endpoint/data/v1/action/findOne`; // https://asia-south1.gcp.data.mongodb-api.com/app/app-gladiators-pvxuj/endpoint/data/v1/action/findOne
