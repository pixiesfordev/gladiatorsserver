...
REM =======Build image=======
docker build --no-cache -f lobby/Dockerfile -t asia-east1-docker.pkg.dev/mygladiators-dev/gladiators/gladiators-lobby:0.1.1 .
@if ERRORLEVEL 1 exit /b 1

REM =======Push image=======
docker push asia-east1-docker.pkg.dev/mygladiators-dev/gladiators/gladiators-lobby:0.1.1
@if ERRORLEVEL 1 exit /b 1
